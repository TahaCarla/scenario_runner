...
class OpenScenarioWithAgent(BasicScenario):

    """
    Implementation of the OpenSCENARIO scenario with an agent
    """
    ...
    def __init__(self, world, ego_vehicles, config, config_file, debug_mode=False, criteria_enable=True, timeout=300):
        ...
        super(OpenScenarioWithAgent, self).__init__("OpenScenarioWithAgent", ego_vehicles=ego_vehicles, config=config,
